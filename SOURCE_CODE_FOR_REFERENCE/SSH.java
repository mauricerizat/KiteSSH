...
public class SSH extends Thread
{
     ...
     */
    public SSH(String hostname, String username, String password, String portNumber, String pkPath, String passphrase, TextArea textArea_terminalOut, 
     ...
     */
    public boolean passwordConnectSSH() throws JSchException
    {
        try
        {
            progress.set(60/100);
